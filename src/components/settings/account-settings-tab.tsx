...
import { Shield, Sparkles, Loader2, Share2, Building, Code, Download } from "lucide-react";
import { useToast } from '@/hooks/use-toast';
import { useAuth } from '@/hooks/use-auth';
import { useFirestore, useAuth as useFirebaseAuth, updateDocument, useCollectionGroup, useMemoFirebase } from '@/firebase';
import { doc, serverTimestamp, collectionGroup, query, where } from 'firebase/firestore';
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Generate and download your personal health data as a FHIR R4 Bundle for interoperability with other healthcare systems.
                </CardDescription>
            </CardHeader>
